Shader "Unlit/LowpassFilterScreenShader"
{
	  Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (PS_INPUT i) : SV_Target
            {
                ...
                _Frequency = lerp(10, 24000, exp((_FrequencyNorm-1)*5)*_FrequencyNorm);
                ...
                _EnvelopeFrequency = min(lerp(10, 24000, exp((_FrequencyNorm+_Envelope-1)*5)*(_FrequencyNorm+_Envelope)),24000);
