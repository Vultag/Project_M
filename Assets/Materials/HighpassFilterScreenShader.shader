Shader "Unlit/HighpassFilterScreenShader"
{
	  Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Function to calculate the magnitude response of the high-pass biquad filter
            ...
            fixed4 frag (PS_INPUT i) : SV_Target
            {
                ...
                _Frequency = lerp(0, 22000, exp((_FrequencyNorm-1)*5)*_FrequencyNorm);
                ...
                _EnvelopeFrequency = max(lerp(0, 22000, exp((_FrequencyNorm+_Envelope-1)*5)*(_FrequencyNorm+_Envelope)),0);
                ...
                float logMinFreq = log10(100.0);
                float logMaxFreq = log10(24000.0);
